  ...
  return (
        ...
        <div className='pt-24 relative'>
                <Suspense fallback={<div>Loading ...</div>}>
                    ...
                    <div className='absolute left-10 top-1/2 -translate-y-1/2 w-1/2 flex flex-col gap-10'>
                        <h1 className='text-5xl font-bold'>{title}</h1>
                        <p className='text-xl'>
                        {description}
                        </p>
                        <a
                        className='px-5 py-2 rounded-full border-2 border-black text-black w-fit bg-transparent hover:bg-gray-100 transition-colors duration-300 ease-in-out'
